            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="index.html#" class="btn btn-mini visible-phone hidden-tablet">View</a>
                                    </td>
                                    <td><a href="index.html#" class="btn btn-mini hidden-phone hidden-tablet">View</a></td>
                                </tr>
                                <tr>
                                    <td class="highlight">
                                ...
                                <tr>
                                    <td class="highlight">
                                        ...
                                        <a href="index.html#">Dolor imit</a>
                                    </td>
                                    <td>Rafiqul Ismal</td>
                                    <td>
                                        490.50$
                                ...
                                <tr>
                                    ...
                                    <td>Sumon Ahmed</td>
                                    <td>1000.00$ <a href="index.html#" class="btn btn-mini visible-phone hidden-tablet">View</a></td>
                                    <td><a href="index.html#" class="btn btn-mini hidden-phone hidden-tablet">View</a></td>
                                </tr>
                                <tr>
                                    <td class="highlight">
                                        <div class="success"></div>
                                        <a href="index.html#">Vector lab</a>
                                    </td>
                                    <td>Mosaddek</td>
                                    <td>
                                        4890.60$
                                ...
                                <tr>
                                    ...
                                    <td>Dulal Khan</td>
                                    <td>500.00$ <a href="index.html#" class="btn btn-mini visible-phone hidden-tablet">View</a></td>
                                    <td><a href="index.html#" class="btn btn-mini hidden-phone hidden-tablet">View</a></td>
                                </tr>
                                <tr>
                                    <td class="highlight">
                        ...
                        <div class="clearfix">
                            <a href="index.html#" class="btn btn-mini pull-right">All Orders</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-body">
                        <div class="timeline-messages">
                            ...
                            <div class="msg-time-chat">
                                <a class="message-img" href="index.html#"><img alt="" src="img/avatar1.jpg" class="avatar" /></a>
                                <div class="message-body msg-in">
                                    <div class="text">
                                        <p class="attribution"><a href="index.html#">Mosaddek Hossain</a> at 1:55pm, 13th April 2013</p>
                            ...
                            <!-- Comment -->
                            <div class="msg-time-chat">
                                <a class="message-img" href="index.html#"><img alt="" src="img/avatar2.jpg" class="avatar" /></a>
                                <div class="message-body msg-out">
                                    <div class="text">
                                        <p class="attribution"><a href="index.html#">Dulal Khan</a> at 2:01pm, 13th April 2013</p>
                            ...
                            <div class="msg-time-chat">
                                ...
                                <div class="message-body msg-in">
                                    <div class="text">
                                        <p class="attribution"><a href="index.html#">Mosaddek Hossain</a> at 2:03pm, 13th April 2013</p>
                            ...
                            <div class="msg-time-chat">
                                ...
                                <div class="message-body msg-out">
                                    <div class="text">
                                        <p class="attribution"><a href="index.html#">Dulal Khan</a> at 2:05pm, 13th April 2013</p>
            ...
            <div class="span4 responsive" data-tablet="span4 fix-margin" data-desktop="span4">
                ...
                <div class="widget">
                    ...
                    <div class="widget-body">
                        <ul class="todo-list">
                            <li>
                                ...
                                <div class="col2">
                                    ...
                                    <span class="actions">
                                        <a href="index.html#" class="icon"><i class="icon-ok"></i></a>
                                        <a href="index.html#" class="icon"><i class="icon-remove"></i></a>
                                    </span>
                                </div>
                            </li>
                            <li>
                        ...
                        <a href="index.html#" class="pull-right">View all todo list</a>
