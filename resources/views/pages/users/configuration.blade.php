        ...
        <div class="span12">
            ...
            <div class="widget">
                ...
                <div class="widget-body form">
                    <!-- BEGIN FORM-->
                    <form method="POST" class="row-fluid" action="{{route('admin.user.configuration')}}" class="form-horizontal">
                        @csrf
                        <div class="span4 ml0">
                            <div class="form-group">
                                <label class="control-label">BV Rate</label>
                                <input name="rate" required type="number" step="0.01" class="form-control" value="{{$conf->rate ?? float(0)}}">
                            </div>
                        </div>
